    ...
    run: async (client, message) => {
        ...
        if (!message.content.startsWith(prefix)) return;
            ...
            try {
                ...
                if ((blacklisted.includes(message.channel.id)) && (message.member.roles.cache.find(r => r.id === '847600287421431828') == null)) return message.channel.send('[DEBUG] Command couldn\'t be used');
